                        ...
                        <div id="error" class="alert alert-danger" role="alert">${error}</div>  
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="Update?userId=<%= user.getId() %>" method="post" enctype ="multipart/form-data">
                                                     
                                             <div class="form-group row">
                                               
                                                   <!-- profile picture -->                                                                                                                                
                                                   <label for="full_name" class="col-md-4 col-form-label text-md-right">Profile picture</label>
                                                   <div class="col-md-6">
                                                       <img width="200px" src="/images/<%= user.getProfilePicture() %>"/>
                                              ...
                                              <div class="form-group row">
                                                  ...
                                                  <div class="col-md-6">
                                                      <input type="text" id="full_name" class="form-control" name="name" value="<%= user.getName() %>" required="true">
                                                  </div>
                                              </div>
                                              ...
                                              <div class="form-group row">
                                                  ...
                                                  <div class="col-md-6">
                                                      <input type="email" id="email_address" class="form-control" name="email" value="<%= user.getEmail() %>" required="true">
                                                  </div>
                                              </div>
                                              ...
                                              <div class="form-group row">
                                                  ...
                                                  <div class="col-md-6">
                                                      <input type="text" id="address" class="form-control" name="address" value="<%= user.getAddress() %>" required="true">
                                                  </div>
                                              </div>
                                              ...
                                              <div class="form-group row">
                                                  ...
                                                  <div class="col-md-6">
                                                      <input type="tel" id="phoneNumber" class="form-control" name="telephoneNumber" value="<%= user.getTelephoneNumber() %>" required="true">
                                                  </div>
                                              </div>
                                              ...
                                              <div class="form-group row">
                                                  ...
                                                  <div class="col-md-6">
                                                      <input type="text" id="username" class="form-control" name="username" value="<%= user.getUsername() %>" required="true">
                                                  </div>
                                              </div>
                                              ...
                                              <div class="form-group row">
                                                  ...
                                                  <div class="col-md-6">
                                                      <input type="text" id="password" class="form-control" name="password" value="<%= user.getPassword() %>" required="true">
                                                  </div>
                                              </div>
